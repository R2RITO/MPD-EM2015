...
function usuario_unico(){
    ...
    if(trim($_POST["usuario"]) != ""){
        ...
        if (($row = oci_fetch_array($valido, OCI_BOTH))) {
            ...
            header('Location: iniciosesionm.php');
            ...
            <div class="12u">
                <section id="pbox1">
                    ...
                    <h2>Inicio de Sesion</h2>
                        <form style="text-align:center;" class="s" action="validar_usuariom.php" method="post">
                            Usuario: <input type="text" id="usuario" name="usuario" size="20" maxlength="20" /><?php verificar_usuario(); ?><br>
                            Contrasena: <input type="password" id="password" name="password" size="10" maxlength="10" /><?php verificar_contrasena(); ?><br>
                            <?php usuario_unico(); ?>
