...
07-41125 Andreina Loriente
	Archivo que muestra el mensaje de error si no se logra eliminar un usuario en
	la base de datos.
<!-->
...
<div id="wrapper">
		...
		<div class="row">
			<div class="12u">
				<section class="content">
					<h2>El paciente no se encuentra registrado</h2>
	...
	<div class="5grid-layout" id="footer1">
		<div class="row">
			<div class="12u">
				<section id="fbox1">
					<p style="text-align:right;"><a href="eliminarpaciente.php" class="button-style1">regresar a eliminar</a></p>	
				</section>
			</div>
		</div>
	</div>
