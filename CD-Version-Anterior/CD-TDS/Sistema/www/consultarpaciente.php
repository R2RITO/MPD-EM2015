...
07-41125 Andreina Loriente
	Archivo que muestra la busqueda a realizar para la base de datos. 
	Contiene 3 tipos distintos de busqueda segun las preferencias 
	del usuario.
<!-->
...
<div id="wrapper">
	...
	<div class="5grid-layout" id="footer1">
		<div class="row">
			<div class="12u">
				<section id="fbox1">
					<p style="text-align:right;"><input class="button-style1" type="submit" value="Consultar"/></p></p>	
				</section>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="12u">
				<section class="content">
					...
					Ingrese la cédula de identidad del paciente a comparar:<br><br>
					<p>
