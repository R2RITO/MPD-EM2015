...
07-41125 Andreina Loriente
	Archivo donde se agregan las preferencias de caracteristicas de marcha del medico usuario.
<!-->
			...
			<div class="12u">
				...
				<h2>Tabla de las Características de la Marcha</h2>
					<div id="demos">
						...
						<form name="frmload" method="post" action="indexE.php" enctype="multipart/form-data">
