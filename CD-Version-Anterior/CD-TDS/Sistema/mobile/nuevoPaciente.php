...
<body>  
 ...
 <div class="">
  <div class="trans">	
	  <form role="form" action="validarPaciente1.php" method="post">
		  <div class="form-group">
			...
			<input class="form-control" size="16" type="text"  id="dpYears" name="dpYears" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">	
                  </div>
