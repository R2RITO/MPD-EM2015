...
<body>  
 ...
 <!-- Consultar Paciente-->
  <div>
     <p class="titulo">Comparar entre Pacientes</p>
 </div>
 <div class="row">
  <div class="col-xs-12 col-md-7 trans">	
	  <form role="form" action="resultadosComparaciones.php">
		  <div class="form-group	">
			<label for="exampleInputEmail1">Cédula del paciente a comparar:</label>
