...
function verificar_campos(){
	...
	if((trim($_POST["nombre"])) == "" | (trim($_POST["apellido"]) == "") | 
            (trim($_POST["cedula"]) == "") | (trim($_POST["profesion"]) == "") | 
            (trim($_POST["residencia"]) == "") | (trim($_POST["dpYears"]) == "") ){
		$valido = false;
	}
	return $valido;
}
...
/**
 * Funcion que busca en la BD al paciente por la cedula para verificar si esta ya existia o no.
 *
 */
...
<body>  
 ...
 <!-- Consultar Paciente-->
  <div>
     <p class="titulo">Agregar Paciente</p>
 </div>
 <div class="">
  <div class="trans">	
	  <form role="form" action="nuevoPaciente2.php" method="post">
		  <div class="form-group">
			<?php paciente_unico(); ?>
			<label for="exampleInputEmail1">Nombre</label>
			<input type="text" class="form-control" id="nombre" name="nombre" placeholder="Jane" value="<?php echo $_POST['nombre']; ?>">
			...
			<input type="text" class="form-control" id="profesion" name="profesion" placeholder="Estudiante">
		        <label for="exampleInputEmail1">Lugar de Residencia</label>
		    	<input type="text" class="form-control" id="residencia" name="residencia" placeholder="Caracas">
                        <label for="exampleInputEmail1">Fecha de Nacimiento</label>
			<input class="span2" size="16" type="text"  id="dpYears" name="dpYears" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">	
