    			...
    			<div class="row-same-height" style="height: 100%;">
	    			...
	    			<div class="col-xs-2 col-xs-height col-top main-menu" >
						<ul class="list-unstyled main-menu">
							...
							<li class="active"><a href="<?php echo "efa_consulta.php" ?>">Examen Físico Articular</a></li>
	    			...
	    			<div class="col-xs-10 col-xs-height col-top main-content">
	    				...
	    				<div class="row">
	    					<div class="col-xs-12 sub-menu">
								<ul class="list-inline ">
									<li><a href="<?php echo "efa_consulta.php" ?>">Consultar</a></li>
									<li class="active"><a href="<?php echo "efa_nuevo.php" ?>">Agregar</a></li>
								</ul>
	    					</div>
	    				</div>
	    				<!-- CONTENT -->
	    				<div class="row">
	    					<div class="col-xs-12 content">
                                ...
                                <h3 class="title">Cadera</h3>
                                <h3 class="title">Rodilla</h3>
                                <h3 class="title">Tobillo</h3>
                                <h3 class="title">Pie</h3>
                                <h3 class="title">Exámenes especiales</h3>
	    					</div>
	    				</div>
	    			</div>
	    		</div>
