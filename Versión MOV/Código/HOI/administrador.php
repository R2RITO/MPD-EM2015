	    			...
	    			<div class="col-xs-10 col-xs-height col-top main-content">
	    				...
	    				<div class="row">
	    					<div class="col-xs-12 sub-menu">
								<ul class="list-inline ">
									<li class="active"><a href="<?php echo "administrador.php" ?>">Dominios Difusos</a></li>
									<li><a href="<?php echo "admin_dimctx.php" ?>">Dimensiones Contextuales</a></li>
								</ul>
	    					</div>
	    				</div>
	    				<!-- CONTENT -->
	    				<div class="row">
	    					<div class="col-xs-12 content">
	    						<h3 class="title">Agregar un dominio difuso</h3>
                                ...
                                <form name="F1"class="form-horizontal" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                    ...
                                    <div>
                                        <button type="submit" class="btn btn-primary" name="submit">Agregar dominio</button>
                                    </div>
                        ...
                        <?php
                            if (isset($_POST['Etiqueta'])) {
                                ...
                                $fdb->agregarDominioDifuso($_POST['Etiqueta']);
                            }
                        ?>
