...
CREATE OR REPLACE TYPE DominioDifuso_TYP AS OBJECT (
	...
	-- ?
) --NOT INSTANTIABLE ? misma razon que antes
...
CREATE OR REPLACE TYPE TrapezoideLista_TYP AS TABLE OF Trapezoide_TYP (
)

CREATE OR REPLACE TYPE Continuo_TYP UNDER DominioDifuso_TYP (
	trapezoide 	TrapezoideLista_TYP,
	-- rangoMin
	-- rangoMax
	-- unidad
